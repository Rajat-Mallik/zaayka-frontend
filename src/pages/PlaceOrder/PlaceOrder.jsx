      ...
      <div className='place-order'>
        <div className='place-order-left'>
          ...
          <div className='multi-fields'>
            ...
            <input required name='country' onChange={onChangeHandler} value={data.country} type='text' placeholder='Country Name'></input>
          </div>
          <input required name='phone' onChange={onChangeHandler} type='text' placeholder='Phone'></input>
        </div>
        <div className='place-order-right'>
          <div className='cart-total'>
            ...
            <button type='submit'>PROCEED TO PAPYMENT</button>
          </div>
        </div>
      </div>
    </form>
